...
public class WorkloadResultsSnapshotTest
{
    ...
    {
        WorkloadResultsSnapshot snapshot1 =
                createSnapshot( 1, TimeUnit.NANOSECONDS, TimeUnit.MICROSECONDS, TimeUnit.MILLISECONDS,
                        TimeUnit.SECONDS );
        WorkloadResultsSnapshot snapshot2 =
                createSnapshot( 1, TimeUnit.NANOSECONDS, TimeUnit.MICROSECONDS, TimeUnit.MILLISECONDS,
                        TimeUnit.SECONDS );
    ...
    @Test
    public void shouldNotEqualWhenDifferentSnapshotsHaveDifferentValues()
            throws WorkloadException, MetricsCollectionException
    {
        WorkloadResultsSnapshot snapshot1 =
                createSnapshot( 1, TimeUnit.NANOSECONDS, TimeUnit.MICROSECONDS, TimeUnit.MILLISECONDS,
                        TimeUnit.SECONDS );
        WorkloadResultsSnapshot snapshot2 =
                createSnapshot( 2, TimeUnit.NANOSECONDS, TimeUnit.MICROSECONDS, TimeUnit.MILLISECONDS,
                        TimeUnit.SECONDS );
    ...
    @Test
    public void shouldStillEqualAfterBeingSerializedAndMarshaledImplementEquals()
            throws WorkloadException, MetricsCollectionException, IOException
    {
        WorkloadResultsSnapshot snapshot1 =
                createSnapshot( 1, TimeUnit.NANOSECONDS, TimeUnit.MICROSECONDS, TimeUnit.MILLISECONDS,
                        TimeUnit.SECONDS );
    ...
    private WorkloadResultsSnapshot createSnapshot( int seed, TimeUnit timeUnit1, TimeUnit timeUnit2,
            TimeUnit timeUnit3, TimeUnit timeUnit4 )
    {
        ...
        ContinuousMetricSnapshot runTimeMetric = new ContinuousMetricSnapshot(
                ...
                runTimeMin,
                runTimeMax,
                0l, runTimePercentile50,
                0l, runTimePercentile90,
                runTimePercentile95,
                runTimePercentile99,
        ...
        metrics.put( Integer.toString( seed++ ),
                new OperationMetricsSnapshot( operationName, operationDurationUnit, operationCount, runTimeMetric ) );
